-- Phase 7 / WP 7.1 stage 1 / §4 D155 + D158 — the sixteen policies learn the second role
--
...
-- it cannot be used, for a reason that is itself a finding (§4 D158): **FIVE of the
