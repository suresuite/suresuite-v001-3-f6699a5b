-- Update integrated process network RPC to use supply_chain_data_multi_tier with correct node typing
-- Level 0 → product, Levels 1-4 → material, Level 5 → supplier, Level -1 → customer
