...
-- Dataset policies (select)
CREATE POLICY IF NOT EXISTS "Datasets: selectable by project owner, admin, or plant access" ON public.bom_single_level FOR SELECT USING (
...
CREATE POLICY IF NOT EXISTS "Datasets: selectable by project owner, admin, or plant access (ml)" ON public.bom_multi_level FOR SELECT USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin' OR p.plant_id IN (SELECT plant FROM public.user_plant_access WHERE user_id = public.get_current_user_id() AND can_view = true)))
);
CREATE POLICY IF NOT EXISTS "Datasets: selectable by project owner, admin, or plant access (inbound)" ON public.inbound_logistics FOR SELECT USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin' OR p.plant_id IN (SELECT plant FROM public.user_plant_access WHERE user_id = public.get_current_user_id() AND can_view = true)))
);
CREATE POLICY IF NOT EXISTS "Datasets: selectable by project owner, admin, or plant access (outbound)" ON public.outbound_logistics FOR SELECT USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin' OR p.plant_id IN (SELECT plant FROM public.user_plant_access WHERE user_id = public.get_current_user_id() AND can_view = true)))
);
CREATE POLICY IF NOT EXISTS "Datasets: selectable by project owner, admin, or plant access (multi-tier)" ON public.multi_tier_supply_chain FOR SELECT USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin' OR p.plant_id IN (SELECT plant FROM public.user_plant_access WHERE user_id = public.get_current_user_id() AND can_view = true)))
);

-- Dataset policies (insert/update/delete) - owner or admin
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can insert" ON public.bom_single_level FOR INSERT WITH CHECK (
...
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can update" ON public.bom_single_level FOR UPDATE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
) WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can delete" ON public.bom_single_level FOR DELETE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);

CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can insert (ml)" ON public.bom_multi_level FOR INSERT WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can update (ml)" ON public.bom_multi_level FOR UPDATE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
) WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can delete (ml)" ON public.bom_multi_level FOR DELETE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);

CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can insert (inbound)" ON public.inbound_logistics FOR INSERT WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can update (inbound)" ON public.inbound_logistics FOR UPDATE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
) WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can delete (inbound)" ON public.inbound_logistics FOR DELETE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);

CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can insert (outbound)" ON public.outbound_logistics FOR INSERT WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can update (outbound)" ON public.outbound_logistics FOR UPDATE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
) WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can delete (outbound)" ON public.outbound_logistics FOR DELETE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);

CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can insert (multi-tier)" ON public.multi_tier_supply_chain FOR INSERT WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can update (multi-tier)" ON public.multi_tier_supply_chain FOR UPDATE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
) WITH CHECK (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
CREATE POLICY IF NOT EXISTS "Datasets: owner or admin can delete (multi-tier)" ON public.multi_tier_supply_chain FOR DELETE USING (
  EXISTS (SELECT 1 FROM public.projects p WHERE p.id = project_id AND (p.modeler_id = public.get_current_user_id() OR (SELECT user_role FROM public.get_current_approved_user() LIMIT 1) = 'admin'))
);
