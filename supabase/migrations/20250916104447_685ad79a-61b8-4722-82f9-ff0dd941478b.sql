-- Fix individual simulation result RPC functions to enforce organization access and resolve ambiguous column references

-- Update get_individual_scenario_results function
...
-- Update get_scenario_simulation_results function
...
-- Update get_baseline_simulation_results function
