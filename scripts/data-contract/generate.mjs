...
function main() {
  ...
  if (checking) {
    ...
    console.log(
      `✓ the contract, its ${files.size - 3} pages and the manual's two generated modules match ` +
  ...
  console.log(
    ...
    `  ${relative(ROOT, CONTRACT_OUT)} + ${files.size - 3} pages under ${relative(ROOT, PAGES_DIR)}/\n` +
