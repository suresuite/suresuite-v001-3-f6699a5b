...
function main() {
  ...
  if (checking) {
    ...
    console.log(
      `✓ the contract, its ${files.size - 2} pages and the manual's data-model module match ` +
  ...
  console.log(
    ...
    `  ${relative(ROOT, CONTRACT_OUT)} + ${files.size - 2} pages under ${relative(ROOT, PAGES_DIR)}/\n` +
