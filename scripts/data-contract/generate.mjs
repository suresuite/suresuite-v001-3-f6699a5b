...
export function renderPolicyModule(contract, registry) {
  ...
  return [
    ...
    "};",
    "",
    `export const STRESS_TESTS: StressTest[] = ${JSON.stringify(deriveStressTests(registry), null, 2)};`,
    "",
    "/**",
    ...
    "};",
    "",
    `export const ASSISTANT: Assistant = ${JSON.stringify(deriveAssistant(ROOT), null, 2)};`,
    "",
    "/**",
    ...
    "};",
    "",
    `export const INTELLIGENCE: Intelligence = ${JSON.stringify(deriveIntelligence(ROOT), null, 2)};`,
    "",
    ...
    "};",
    "",
    `export const AI_GOVERNANCE: AiGovernance = ${JSON.stringify(deriveAiGovernance(ROOT), null, 2)};`,
    "",
    "/**",
    ...
    "};",
    "",
    `export const POLICY_PRESETS: PolicyPreset[] = ${JSON.stringify(derivePresets(ROOT), null, 2)};`,
    "",
    "/**",
    ...
    "};",
    "",
    `export const VALIDATION_CARD: ValidationCard = ${JSON.stringify(deriveValidationCard(ROOT), null, 2)};`,
    "",
    "/**",
    ...
    "};",
    "",
    `export const PROJECT_DELETION: ProjectDeletion = ${JSON.stringify(deriveProjectDeletion(ROOT), null, 2)};`,
    "",
    "/**",
    ...
    "};",
    "",
    `export const ADMIN_SCREENS: AdminScreens = ${JSON.stringify(deriveAdminScreens(ROOT), null, 2)};`,
    "",
    "/**",
    ...
    "};",
    "",
    `export const READ_EXPOSURE: ReadExposure = ${JSON.stringify(deriveReadExposure(ROOT), null, 2)};`,
    "",
