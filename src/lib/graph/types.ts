/**
 * The graph layer's vocabulary — Phase 8 / WP 8.3 / §4 D112.
 *
 ...
 * the whole of D112: a BOM three levels deep does not mean three tiers of
 ...
 *
 * IDENTITY IS `{ echelon, id }` AND NOT `id` ALONE. §4 D116: the id is a bare
...
export interface GraphNode {
   ...
   * about (§4 D125) and one of which discards the real depth for a literal 2.
   */
