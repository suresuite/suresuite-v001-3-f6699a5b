...
export const DOC_GROUPS: DocGroup[] = [
  ...
  },
  {
    ...
    pages: [
      { ...planned("5.2b"), slug: "inbound-logistics", table: "inbound_logistics", title: "Inbound Logistics", summary: "Supply arcs: which supplier delivers which material, at what price and lead time.", keywords: "inbound logistics supplier material volume lead time unit price csv", source: "contract" },
      { ...planned("5.2b"), slug: "outbound-logistics", table: "outbound_logistics", title: "Outbound Logistics", summary: "Demand arcs: which customer buys which product, at what price and lead time.", keywords: "outbound logistics customer product volume expected lead time unit price csv", source: "contract" },
      { ...planned("5.2b"), slug: "bom-single-level", table: "bom_single_level", title: "BOM — single level", summary: "How much of each material one unit of a product consumes.", keywords: "bom bill of materials single level product material consumption rate", source: "contract" },
      { ...planned("5.2b"), slug: "bom-multi-level", table: "bom_multi_level", title: "BOM — multi level", summary: "The deep bill of materials, level by level.", keywords: "bom bill of materials multi level higher level component consumption rate depth", source: "contract" },
      { ...planned("5.2b"), slug: "materials", table: "materials", title: "Materials", summary: "The economics the simulation reads for each material.", keywords: "materials cost holding cost moq initial on hand lead time distribution cv", source: "contract" },
      { ...planned("5.2b"), slug: "products", table: "products", title: "Products", summary: "Price, capacity, fulfilment mode and the shape of demand.", keywords: "products sell price production capacity fulfillment mode demand distribution mean cv", source: "contract" },
      { ...planned("5.2b"), slug: "suppliers", table: "suppliers", title: "Suppliers", summary: "Capacity and reliability, beyond the arcs that connect a supplier to materials.", keywords: "suppliers capacity per week reliability score", source: "contract" },
      { ...planned("5.2b"), slug: "node-list", table: "node_list", title: "Node List", summary: "Named locations and their coordinates.", keywords: "node list location longitude latitude description map", source: "contract" },
      { ...planned("5.2b"), slug: "deep-tier-nodes", table: "network_nodes", title: "Deep-Tier Nodes", summary: "Firms discovered beyond tier one, with the attributes known about each.", keywords: "network nodes deep tier firm depth country industry employees revenue seed", source: "contract" },
      { ...planned("5.2b"), slug: "deep-tier-edges", table: "network_edges", title: "Deep-Tier Edges", summary: "Relationships between deep-tier firms, and their direction.", keywords: "network edges deep tier relation type relative revenue direction depth", source: "contract" },
      { ...planned("5.2b"), slug: "multi-tier-suppliers", table: "multi_tier_supply_chain", title: "Multi-Tier Suppliers", summary: "The firm-to-firm supply relationships that make up the deep chain.", keywords: "multi tier supply chain from firm to firm tier relationship", source: "contract" },
      { ...planned("5.2b"), slug: "units-and-time-periods", title: "Units and time periods", summary: "The page that settles time_unit against lead_time, once.", keywords: "units time period week day lead time unit conversion normalization" },
    ],
  },
  {
    section: 4,
  ...
  },
  {
    ...
    pages: [
      { ...planned("5.2c"), slug: "how-policies-work", title: "How policies work", summary: "Stages, scope, and defaults against overrides.", keywords: "policies stages scope defaults overrides bundle patch" },
      { ...planned("5.2c"), slug: "supplier-stage", title: "Supplier stage", summary: "Every column of the supplier policy grid.", keywords: "supplier stage policy grid columns sourcing backup expediting", source: "contract" },
      { ...planned("5.2c"), slug: "plant-stage", title: "Plant stage", summary: "Every column of the plant policy grid.", keywords: "plant stage policy grid columns production capacity overtime inventory", source: "contract" },
      { ...planned("5.2c"), slug: "customer-stage", title: "Customer stage", summary: "Every column of the customer policy grid.", keywords: "customer stage policy grid columns fulfilment allocation service", source: "contract" },
      { ...planned("5.2c"), slug: "policy-types", title: "Policy types", summary: "Min/max, base stock, ROP-Q and periodic review, and when each applies.", keywords: "policy types min max base stock rop q reorder point periodic review inventory", source: "registry" },
      { ...planned("5.2c"), slug: "policy-catalog", title: "The policy catalog", summary: "Every policy in the catalog, by stage.", keywords: "policy catalog supplier plant transport customer forecasting cross cutting", source: "registry" },
      { ...planned("5.2c"), slug: "where-a-number-came-from", title: "Where a number came from", summary: "The provenance dots, and what each one is telling you.", keywords: "provenance dots source derived default substitution colour grid" },
      { ...planned("5.2c"), slug: "when-a-value-is-missing", title: "When a value is missing", summary: "Every substitution the system will make, and how it is marked.", keywords: "missing value substitution fallback default derived chain grade", source: "contract" },
      { ...planned("5.2c"), slug: "policy-versions-and-presets", title: "Policy versions & presets", summary: "Saving, reusing and comparing policy sets.", keywords: "policy versions presets save reuse compare snapshot" },
    ],
  },
  {
    section: 6,
    ...
    pages: [
      { ...planned("5.2c"), slug: "verify-your-inputs", title: "Verify your inputs", summary: "Block, warn and info findings — and how to clear each one.", keywords: "verify validation findings block warn info grading clear errors" },
      { ...planned("5.2c"), slug: "data-trust-report", title: "Data Trust Report", summary: "Coverage, freshness, ingest history and known limits in one artifact.", keywords: "data trust report coverage freshness ingest history staleness" },
      { ...planned("5.2c"), slug: "model-validation", title: "Model validation", summary: "Checking the model against what actually happened.", keywords: "model validation backtest comparison actuals" },
    ],
  },
  {
    section: 7,
    ...
    pages: [
      { ...planned("5.2d"), slug: "simulation-lab", title: "Simulation Lab — running an experiment", summary: "Preview and experiment modes, and what each produces.", keywords: "simulation lab run experiment preview replications jobs" },
      { ...planned("5.2d"), slug: "scenarios", title: "Scenarios", summary: "Saving and reusing a set of conditions.", keywords: "scenarios templates sim scenarios saved conditions" },
      { ...planned("5.2d"), slug: "disruptions", title: "Disruptions", summary: "Profiles, settings, targets and effects.", keywords: "disruption scenarios profiles settings targets effects shock outage" },
      { ...planned("5.2d"), slug: "recovery-playbooks", title: "Recovery playbooks", summary: "What the chain does once something has gone wrong.", keywords: "recovery playbooks response mitigation strategy" },
      { ...planned("5.2d"), slug: "experiments-and-comparison", title: "Experiments & comparison", summary: "Ranking strategies against each other.", keywords: "experiments comparison compare ranking portfolio synergy" },
      { ...planned("5.2d"), slug: "seeds-replications-confidence", title: "Seeds, replications & confidence", summary: "Why the same run gives a range, and how wide that range is.", keywords: "seeds replications confidence intervals crn warmup bootstrap statistics", source: "registry" },
      { ...planned("5.2d"), slug: "stress-tests", title: "Stress tests", summary: "The standing stress-test battery and what each one probes.", keywords: "stress tests battery st1 st7 robustness" },
    ],
  },
  {
    section: 8,
  ...
  },
  {
    ...
    pages: [
      { ...planned("5.2d"), slug: "reading-your-results", title: "Reading your results", summary: "What a run produces and how to interpret it.", keywords: "results runs replications interpret read output", source: "registry" },
      { ...planned("5.2d"), slug: "kpis-and-resilience-index", title: "KPIs & the Resilience Index", summary: "Every KPI, its definition and its unit.", keywords: "kpi fill rate cost of resilience ttr tts resilience index service level", source: "registry" },
      { ...planned("5.2d"), slug: "per-item-time-series", title: "Per-item time series", summary: "What happened to one material, week by week.", keywords: "time series per item weekly inventory backlog series", source: "registry" },
      { ...planned("5.2d"), slug: "performance-and-caching", title: "Performance & caching", summary: "Why a second run is faster, and when the cache is dropped.", keywords: "performance caching metrics speed invalidation" },
      { ...planned("5.2d"), slug: "reports-and-files", title: "Reports & files", summary: "Rendered reports and where they are kept.", keywords: "reports files render export download user files" },
    ],
  },
  {
    section: 12,
