...
#### J · Baseline numbers
  ...
  - **Two §15 runs, none lost to the deploy race.** The before-run went out FIRST,
    ...
    the trigger's three doors.
  - **Two findings: D72 and D73.** Neither came from reading code looking for
    defects: D72 came from enumerating a blast radius, D73 from a rehearsal
    assertion failing in one mode out of three.
