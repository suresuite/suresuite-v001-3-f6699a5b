...
#### C · D113 · THE DEFECT THE REHEARSAL FOUND, AND IT WAS NOT OURS
...
#### D · D112 · THE DECLARATION THAT WOULD HAVE VANISHED
...
defect can CREATE a measurement: D112 is closed, and the report now publishes how
many unevaluable fields there are *because* it is closed. So a ref may name a closed
row only if the ref ITSELF says so — `§4 D112 (closed — this is the measurement it
...
D112 reporting itself. **540 tests ✓** (was 526). `typecheck` ✓ 28 of 28 held.
...
1. **A template that always fills an optional column hides every defect in that
   column's blank path.** D113 survived three packages behind
...
**Verified:** 555 tests ✓ · `contract:check` ✓ (one R13 warning, which is D112
...
*(surface half; the page is WP 6.4's)*, plus D112 and D113 found and closed inside
...
#### C · D114 · THE GATE THAT WAS READING PAST ITS OWN FUNCTION
