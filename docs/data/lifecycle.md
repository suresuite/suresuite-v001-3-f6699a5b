...
> **Status: AUTHORED** · hand-maintained, not generated.
> **Supersedes:** `docs/simulation-data-lifecycle.md` (tombstoned at that path).
> **Scope:** where each piece of project state lives and how long it survives —
> the state tiers behind `docs/PLAN.md` §2's six-tier spine.
